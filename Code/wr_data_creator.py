...
wr_data[("NFL Career Marks since 2000", "# of top  24 finishes")].fillna(value=0, inplace=True)
...
wr_data["true_points"], wr_data["broke_160pts"], wr_data["broke_10ppg"], wr_data["hit"] = helpers.generate_ppr_ppg_by_48(wr_data)
