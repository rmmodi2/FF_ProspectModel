...
filtered_columns = filtered_columns.drop(columns=[('Unnamed: 0_level_0', 'Unnamed: 0_level_1'), ('Unnamed: 0_level_0', 'Name'), ('Unnamed: 1_level_0', 'School'), ('score_hdr', 'Score'), ('Breakout Ages', '>20%'),
	('Dominator', 'BEST'), ('Context Scores', 'Last S/EX'), ('Combine', 'WaSS'), ('Combine', 'HaSS'), ('MS Yards', 'BEST')])
